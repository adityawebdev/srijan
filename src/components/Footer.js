            ...
            <div className="w-full mx-auto flex flex-wrap gap-8 lg:gap-0">
              <div className="flex w-full lg:w-1/2">
                <div className="px-3 md:px-0">
                  <h3 className="font-bold text-gold lg:text-xl">
                    Get in touch
                  </h3>
                  <ul className="list-reset items-center pt-4">
                    <li>
                      <a
                        className="inline-block no-underline text-gold hover:underline hover:text-gold py-1"
                      ...
                      >
                        ...
                        <span className="pl-2 text-gold">
                          srijan.bcas2023@gmail.com
                        </span>
                      </a>
                    </li>
                    <li>
                      <a
                        className="inline-block no-underline hover:text-gold hover:underline py-1 text-gold"
                      ...
                      >
                        ...
                        <span className="pl-2 text-gold">Srijan</span>
                      </a>
                    </li>
                    <li>
                      <a
              ...
              <div className="flex w-full lg:w-1/2">
                <div className="px-3 md:px-0">
                  <h3 className="font-bold text-gold lg:text-xl">Find Us</h3>
                  <div className="pt-4">
                    <a
                      className="inline-block no-underline text-gold hover:underline hover:text-gold py-1"
